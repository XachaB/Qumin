...
My Phd is supervised by `Olivier Bonami <http://www.llf.cnrs.fr/fr/Gens/Bonami>`_ .

The code can be found in the `Qumin github <https://github.com/XachaB/Qumin>`_ repository.
...
Alternation patterns serve as a basis for all the other scripts. The algorithm to find the patterns was presented in: Sacha Beniamine. `Un algorithme universel pour l'abstraction automatique d'alternances morphophonologiques <https://halshs.archives-ouvertes.fr/hal-01615899>`_, 24e Conférence sur le Traitement Automatique des Langues Naturelles  (TALN), Jun 2017, Orléans, France. 2 (2017), 2017, 24e Conférence sur le Traitement Automatique des Langues Naturelles.

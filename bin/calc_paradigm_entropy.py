...
def main(args):
    ...
    if args.onePred or args.nPreds or args.probabilities or args.comp:
        ...
        parser.error("No action requested,"
                     " add --onePred, --nPreds or --probabilities")
...
if __name__ == '__main__':
    ...
    actions.add_argument("-o", "--onePred",
                         help="Compute entropy for pair of cells",
                         action="store_true",
                         default=False)

...
def microclass_heatmap(distances, path, labels=None, cmap_name="BuPu"):
    ...
    if labels is not None:
        ...
        sns.clustermap(distances,method="average",xticklabels="auto",yticklabels="auto",linewidths=0,
        ...
        sns.clustermap(distances,method="average",xticklabels="auto",yticklabels="auto",
...
def main(args):
    r"""Draw a clustermap of microclass similarities.
    ...
    print("Drawing")
    microclass_heatmap(distances, args.output, labels=categories, cmap_name=args.cmap)
